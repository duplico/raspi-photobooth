...
# Made more Pythonic by George Louthan
...
takephotocommand = [COMMANDSEND, SERIALNUM, CMD_TAKEPHOTO, 0x01,
...
def takephoto():
    ...
    r = list(reply)
    # print r
    return checkreply( r, CMD_TAKEPHOTO) and r[3] == chr(0x0)
